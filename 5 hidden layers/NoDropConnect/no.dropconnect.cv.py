...
w2 = tf.Variable(tf.random_normal([400, 250], stddev=0.03), name='w2')
b2 = tf.Variable(tf.random_normal([250]), name='b2')

w3 = tf.Variable(tf.random_normal([250, 150], stddev=0.03), name='w3')
b3 = tf.Variable(tf.random_normal([150]), name='b3')

w4 = tf.Variable(tf.random_normal([150, 120], stddev=0.03), name='w4')
b4 = tf.Variable(tf.random_normal([120]), name='b4')

w5 = tf.Variable(tf.random_normal([120, 80], stddev=0.03), name='w5')
b5 = tf.Variable(tf.random_normal([80]), name='b5')

w6 = tf.Variable(tf.random_normal([80, 10], stddev=0.03), name='w6')
...
y_ = tf.add(tf.matmul(hidden_out_5, w6), b6)
y_ = tf.nn.softmax(y_)

...
# Here applying the dropConnect between hidden layer 5 and hidden layer 6.
...
for keep_percent in np.arange(1, 0.0, -0.05):  # dropping keep_percent in steps of 0.05 in every iteration
    ...
    w6 = tf.Variable(dropConnect(np.genfromtxt('trained_w6.csv', delimiter="\t"), p=keep_percent), dtype=tf.float32, name='w6')
...
# np.savetxt("dl5AccuracyTestNoRetrain.csv", accuracyTest, delimiter="\n", fmt='%.4f')
# np.savetxt("dl5AccuracyTrainNoRetrain.csv", accuracyTrain, delimiter="\n", fmt='%.4f')
# np.savetxt("dl5cvResultsNoRetrain.csv", cvResult, delimiter="\t", fmt='%.4f')

np.savetxt("dl5AccuracyTestWithRetrain.csv", accuracyTest, delimiter="\n", fmt='%.4f')
np.savetxt("dl5AccuracyTrainWithRetrain.csv", accuracyTrain, delimiter="\n", fmt='%.4f')
np.savetxt("dl5cvResultsWithRetrain.csv", cvResult, delimiter="\t", fmt='%.4f')

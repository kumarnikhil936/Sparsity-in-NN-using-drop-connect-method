...
dl7accuracyTest1 = pandas.read_csv("dl7AccuracyTestWithRetrain.csv", sep=',', header=None)
dl7accuracyTrain1 = pandas.read_csv("dl7AccuracyTrainWithRetrain.csv", sep=',', header=None)

dl7accuracyTest2 = pandas.read_csv("dl7AccuracyTestNoRetrain.csv", sep=',', header=None)
dl7accuracyTrain2 = pandas.read_csv("dl7AccuracyTrainNoRetrain.csv", sep=',', header=None)

dl8accuracyTest1 = pandas.read_csv("dl8AccuracyTestWithRetrain.csv", sep=',', header=None)
dl8accuracyTrain1 = pandas.read_csv("dl8AccuracyTrainWithRetrain.csv", sep=',', header=None)

dl8accuracyTest2 = pandas.read_csv("dl8AccuracyTestNoRetrain.csv", sep=',', header=None)
dl8accuracyTrain2 = pandas.read_csv("dl8AccuracyTrainNoRetrain.csv", sep=',', header=None)

dl9accuracyTest1 = pandas.read_csv("dl9AccuracyTestWithRetrain.csv", sep=',', header=None)
dl9accuracyTrain1 = pandas.read_csv("dl9AccuracyTrainWithRetrain.csv", sep=',', header=None)

dl9accuracyTest2 = pandas.read_csv("dl9AccuracyTestNoRetrain.csv", sep=',', header=None)
dl9accuracyTrain2 = pandas.read_csv("dl9AccuracyTrainNoRetrain.csv", sep=',', header=None)
...
plt.ylabel('Accuracy')
plt.grid(True)
plt.title('\n9 Hidden layers : Accuracy for sparsity applied uniformly over all hidden layers with retraining')
...
plt.ylabel('Accuracy')
plt.grid(True)
plt.title('\n9 Hidden layers : Accuracy for sparsity applied uniformly over all hidden layers without retraining')
...
plt.ylabel('Accuracy')
plt.grid(True)
plt.title('\n9 Hidden layers : Accuracy for sparsity applied between hidden layer 1 and 2 with retraining')
...
plt.ylabel('Accuracy')
plt.grid(True)
plt.title('\n9 Hidden layers : Accuracy for sparsity applied between hidden layer 1 and 2 without retraining')
...
plt.ylabel('Accuracy')
plt.grid(True)
plt.title('\n9 Hidden layers : Accuracy for sparsity applied between hidden layer 2 and 3 with retraining')
...
plt.ylabel('Accuracy')
plt.grid(True)
plt.title('\n9 Hidden layers : Accuracy for sparsity applied between hidden layer 2 and 3 without retraining')
...
plt.ylabel('Accuracy')
plt.grid(True)
plt.title('\n9 Hidden layers : Accuracy for sparsity applied between input layer and hidden layer 1 with retraining')
...
plt.ylabel('Accuracy')
plt.grid(True)
plt.title('\n9 Hidden layers : Accuracy for sparsity applied between input layer and hidden layer 1 without retraining')
...
plt.ylabel('Accuracy')
plt.grid(True)
plt.title('\n9 Hidden layers : Accuracy for sparsity applied between hidden layer 3 and 4 with retraining')
...
plt.ylabel('Accuracy')
plt.grid(True)
plt.title('\n9 Hidden layers : Accuracy for sparsity applied between hidden layer 3 and 4 without retraining')
...
plt.ylabel('Accuracy')
plt.grid(True)
plt.title('\n9 Hidden layers : Accuracy for sparsity applied between hidden layer 4 and 5 with retraining')
...
plt.ylabel('Accuracy')
plt.grid(True)
plt.title('\n9 Hidden layers : Accuracy for sparsity applied between hidden layer 4 and 5 without retraining')
...
plt.ylabel('Accuracy')
plt.grid(True)
plt.title('\n9 Hidden layers : Accuracy for sparsity applied between hidden layer 5 and 6 with retraining')
...
plt.ylabel('Accuracy')
plt.grid(True)
plt.title('\n9 Hidden layers : Accuracy for sparsity applied between hidden layer 5 and 6 without retraining')
...
plt.ylabel('Accuracy')
plt.grid(True)
plt.title('\n9 Hidden layers : Accuracy for sparsity applied between hidden layer 6 and 7 with retraining')
...
plt.ylabel('Accuracy')
plt.grid(True)
plt.title('\n9 Hidden layers : Accuracy for sparsity applied between hidden layer 6 and 7 without retraining')
...
plt.ylabel('Accuracy')
plt.grid(True)
plt.title('\n9 Hidden layers : Accuracy for sparsity applied between hidden layer 7 and 8 with retraining')
plt.plot(x, dl7accuracyTest1, linewidth=2, markersize=5, label="test")
plt.plot(x, dl7accuracyTrain1, linewidth=2, markersize=5, label="train")
# plt.show()
plt.legend(bbox_to_anchor=(1.05, 1), loc=2, borderaxespad=0.)
plt.gcf().set_size_inches(18.5, 10.5)
plt.savefig('dl7DropConnectWithRetrain.png')

plt.figure(18)
plt.xlabel('Percentage of weights kept from 5% to 100%')
plt.ylabel('Accuracy')
plt.grid(True)
plt.title('\n9 Hidden layers : Accuracy for sparsity applied between hidden layer 7 and 8 without retraining')
plt.plot(x, dl7accuracyTest2, linewidth=2, markersize=5, label="test")
plt.plot(x, dl7accuracyTrain2, linewidth=2, markersize=5, label="train")
# plt.show()
plt.legend(bbox_to_anchor=(1.05, 1), loc=2, borderaxespad=0.)
plt.gcf().set_size_inches(18.5, 10.5)
plt.savefig('dl7DropConnectNoRetrain.png')

plt.figure(19)
plt.xlabel('Percentage of weights kept from 5% to 100%')
plt.ylabel('Accuracy')
plt.grid(True)
plt.title('\n9 Hidden layers : Accuracy for sparsity applied between hidden layer 8 and 9 with retraining')
plt.plot(x, dl8accuracyTest1, linewidth=2, markersize=5, label="test")
plt.plot(x, dl8accuracyTrain1, linewidth=2, markersize=5, label="train")
# plt.show()
plt.legend(bbox_to_anchor=(1.05, 1), loc=2, borderaxespad=0.)
plt.gcf().set_size_inches(18.5, 10.5)
plt.savefig('dl8DropConnectWithRetrain.png')

plt.figure(20)
plt.xlabel('Percentage of weights kept from 5% to 100%')
plt.ylabel('Accuracy')
plt.grid(True)
plt.title('\n9 Hidden layers : Accuracy for sparsity applied between hidden layer 8 and 9 without retraining')
plt.plot(x, dl8accuracyTest2, linewidth=2, markersize=5, label="test")
plt.plot(x, dl8accuracyTrain2, linewidth=2, markersize=5, label="train")
# plt.show()
plt.legend(bbox_to_anchor=(1.05, 1), loc=2, borderaxespad=0.)
plt.gcf().set_size_inches(18.5, 10.5)
plt.savefig('dl8DropConnectNoRetrain.png')

plt.figure(21)
plt.xlabel('Percentage of weights kept from 5% to 100%')
plt.ylabel('Accuracy')
plt.grid(True)
plt.title('\n9 Hidden layers : Accuracy for sparsity applied between hidden layer 9 and output layer with retraining')
plt.plot(x, dl9accuracyTest1, linewidth=2, markersize=5, label="test")
plt.plot(x, dl9accuracyTrain1, linewidth=2, markersize=5, label="train")
# plt.show()
plt.legend(bbox_to_anchor=(1.05, 1), loc=2, borderaxespad=0.)
plt.gcf().set_size_inches(18.5, 10.5)
plt.savefig('dl9DropConnectWithRetrain.png')

plt.figure(22)
plt.xlabel('Percentage of weights kept from 5% to 100%')
plt.ylabel('Accuracy')
plt.grid(True)
plt.title('\n9 Hidden layers : Accuracy for sparsity applied between hidden layer 9 and output layer without retraining')
plt.plot(x, dl9accuracyTest2, linewidth=2, markersize=5, label="test")
plt.plot(x, dl9accuracyTrain2, linewidth=2, markersize=5, label="train")
# plt.show()
plt.legend(bbox_to_anchor=(1.05, 1), loc=2, borderaxespad=0.)
plt.gcf().set_size_inches(18.5, 10.5)
plt.savefig('dl9DropConnectNoRetrain.png')

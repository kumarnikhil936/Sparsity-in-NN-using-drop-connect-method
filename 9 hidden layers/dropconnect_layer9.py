...
# Here applying the dropConnect between hidden layer 9 and output layer.
...
for keep_percent in np.arange(1, 0.0, -0.05):  # dropping keep_percent in steps of 0.05 in every iteration
    ...
    w10 = tf.Variable(dropConnect(np.genfromtxt('trained_w10.csv', delimiter="\t"), p=keep_percent), dtype=tf.float32, name='w10')
...
# np.savetxt("dl9AccuracyTestNoRetrain.csv", accuracyTest, delimiter="\n", fmt='%.4f')
# np.savetxt("dl9AccuracyTrainNoRetrain.csv", accuracyTrain, delimiter="\n", fmt='%.4f')
# np.savetxt("dl9cvResultsNoRetrain.csv", cvResult, delimiter="\t", fmt='%.4f')

np.savetxt("dl9AccuracyTestWithRetrain.csv", accuracyTest, delimiter="\n", fmt='%.4f')
np.savetxt("dl9AccuracyTrainWithRetrain.csv", accuracyTrain, delimiter="\n", fmt='%.4f')
np.savetxt("dl9cvResultsWithRetrain.csv", cvResult, delimiter="\t", fmt='%.4f')

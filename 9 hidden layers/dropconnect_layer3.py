...
# Here applying the dropConnect between hidden layer 3 and hidden layer 4.
...
for keep_percent in np.arange(1, 0.0, -0.05):  # dropping keep_percent in steps of 0.05 in every iteration
    ...
    w4 = tf.Variable(dropConnect(np.genfromtxt('trained_w4.csv', delimiter="\t"), p=keep_percent), dtype=tf.float32, name='w4')
...
# np.savetxt("dl3AccuracyTestNoRetrain.csv", accuracyTest, delimiter="\n", fmt='%.4f')
# np.savetxt("dl3AccuracyTrainNoRetrain.csv", accuracyTrain, delimiter="\n", fmt='%.4f')
# np.savetxt("dl3cvResultsNoRetrain.csv", cvResult, delimiter="\t", fmt='%.4f')

np.savetxt("dl3AccuracyTestWithRetrain.csv", accuracyTest, delimiter="\n", fmt='%.4f')
np.savetxt("dl3AccuracyTrainWithRetrain.csv", accuracyTrain, delimiter="\n", fmt='%.4f')
np.savetxt("dl3cvResultsWithRetrain.csv", cvResult, delimiter="\t", fmt='%.4f')

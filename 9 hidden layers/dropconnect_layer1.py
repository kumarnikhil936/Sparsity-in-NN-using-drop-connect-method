...
# Here applying the dropConnect between hidden layer 1 and hidden layer 2.
...
for keep_percent in np.arange(1, 0.0, -0.05):  # dropping keep_percent in steps of 0.05 in every iteration
    ...
    w2 = tf.Variable(dropConnect(np.genfromtxt('trained_w2.csv', delimiter="\t"), p=keep_percent), dtype=tf.float32, name='w2')
...
# np.savetxt("dl1AccuracyTestNoRetrain.csv", accuracyTest, delimiter="\n", fmt='%.4f')
# np.savetxt("dl1AccuracyTrainNoRetrain.csv", accuracyTrain, delimiter="\n", fmt='%.4f')
# np.savetxt("dl1cvResultsNoRetrain.csv", cvResult, delimiter="\t", fmt='%.4f')

np.savetxt("dl1AccuracyTestWithRetrain.csv", accuracyTest, delimiter="\n", fmt='%.4f')
np.savetxt("dl1AccuracyTrainWithRetrain.csv", accuracyTrain, delimiter="\n", fmt='%.4f')
np.savetxt("dl1cvResultsWithRetrain.csv", cvResult, delimiter="\t", fmt='%.4f')

...
# Here applying the dropConnect between hidden layer 4 and hidden layer 5.
...
for keep_percent in np.arange(1, 0.0, -0.05):  # dropping keep_percent in steps of 0.05 in every iteration
    ...
    w5 = tf.Variable(dropConnect(np.genfromtxt('trained_w5.csv', delimiter="\t"), p=keep_percent), dtype=tf.float32, name='w5')
...
# np.savetxt("dl4AccuracyTestNoRetrain.csv", accuracyTest, delimiter="\n", fmt='%.4f')
# np.savetxt("dl4AccuracyTrainNoRetrain.csv", accuracyTrain, delimiter="\n", fmt='%.4f')
# np.savetxt("dl4cvResultsNoRetrain.csv", cvResult, delimiter="\t", fmt='%.4f')

np.savetxt("dl4AccuracyTestWithRetrain.csv", accuracyTest, delimiter="\n", fmt='%.4f')
np.savetxt("dl4AccuracyTrainWithRetrain.csv", accuracyTrain, delimiter="\n", fmt='%.4f')
np.savetxt("dl4cvResultsWithRetrain.csv", cvResult, delimiter="\t", fmt='%.4f')

...
# Here applying the dropConnect between hidden layer 6 and hidden layer 7.
...
for keep_percent in np.arange(1, 0.0, -0.05):  # dropping keep_percent in steps of 0.05 in every iteration
    ...
    w7 = tf.Variable(dropConnect(np.genfromtxt('trained_w7.csv', delimiter="\t"), p=keep_percent), dtype=tf.float32, name='w7')
...
# np.savetxt("dl6AccuracyTestNoRetrain.csv", accuracyTest, delimiter="\n", fmt='%.4f')
# np.savetxt("dl6AccuracyTrainNoRetrain.csv", accuracyTrain, delimiter="\n", fmt='%.4f')
# np.savetxt("dl6cvResultsNoRetrain.csv", cvResult, delimiter="\t", fmt='%.4f')

np.savetxt("dl6AccuracyTestWithRetrain.csv", accuracyTest, delimiter="\n", fmt='%.4f')
np.savetxt("dl6AccuracyTrainWithRetrain.csv", accuracyTrain, delimiter="\n", fmt='%.4f')
np.savetxt("dl6cvResultsWithRetrain.csv", cvResult, delimiter="\t", fmt='%.4f')

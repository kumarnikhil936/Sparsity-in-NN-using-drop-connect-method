...
# Here applying the dropConnect between input layer and hidden layer 1.
...
for keep_percent in np.arange(1, 0.0, -0.05):  # dropping keep_percent in steps of 0.05 in every iteration
    ...
    w1 = tf.Variable(dropConnect(np.genfromtxt('trained_w1.csv', delimiter="\t"), p=keep_percent), dtype=tf.float32, name='w1')
    ...
    w3 = tf.Variable(np.genfromtxt('trained_w3.csv', delimiter="\t"), dtype=tf.float32, name='w3')
    ...
    w5 = tf.Variable(np.genfromtxt('trained_w5.csv', delimiter="\t"), dtype=tf.float32, name='w5')
    b5 = tf.Variable(np.genfromtxt('trained_b5.csv', delimiter="\t"), dtype=tf.float32, name='b5')

    w6 = tf.Variable(np.genfromtxt('trained_w6.csv', delimiter="\t"), dtype=tf.float32, name='w6')
    b6 = tf.Variable(np.genfromtxt('trained_b6.csv', delimiter="\t"), dtype=tf.float32, name='b6')

    w7 = tf.Variable(np.genfromtxt('trained_w7.csv', delimiter="\t"), dtype=tf.float32, name='w7')
    b7 = tf.Variable(np.genfromtxt('trained_b7.csv', delimiter="\t"), dtype=tf.float32, name='b7')

    w8 = tf.Variable(np.genfromtxt('trained_w8.csv', delimiter="\t"), dtype=tf.float32, name='w8')
    b8 = tf.Variable(np.genfromtxt('trained_b8.csv', delimiter="\t"), dtype=tf.float32, name='b8')

    w9 = tf.Variable(np.genfromtxt('trained_w9.csv', delimiter="\t"), dtype=tf.float32, name='w9')
    b9 = tf.Variable(np.genfromtxt('trained_b9.csv', delimiter="\t"), dtype=tf.float32, name='b9')

    w10 = tf.Variable(np.genfromtxt('trained_w10.csv', delimiter="\t"), dtype=tf.float32, name='w10')
    b10 = tf.Variable(np.genfromtxt('trained_b10.csv', delimiter="\t"), dtype=tf.float32, name='b10')
    ...
    hidden_out_8 = tf.nn.relu(tf.add(tf.matmul(hidden_out_7, w8), b8))

    hidden_out_9 = tf.nn.relu(tf.add(tf.matmul(hidden_out_8, w9), b9))

    y_ = tf.nn.softmax(tf.add(tf.matmul(hidden_out_9, w10), b10))
...
# np.savetxt("dlinputAccuracyTestNoRetrain.csv", accuracyTest, delimiter="\n", fmt='%.4f')
# np.savetxt("dlinputAccuracyTrainNoRetrain.csv", accuracyTrain, delimiter="\n", fmt='%.4f')
# np.savetxt("dlinputcvResultsNoRetrain.csv", cvResult, delimiter="\t", fmt='%.4f')

np.savetxt("dlinputAccuracyTestWithRetrain.csv", accuracyTest, delimiter="\n", fmt='%.4f')
np.savetxt("dlinputAccuracyTrainWithRetrain.csv", accuracyTrain, delimiter="\n", fmt='%.4f')
np.savetxt("dlinputcvResultsWithRetrain.csv", cvResult, delimiter="\t", fmt='%.4f')

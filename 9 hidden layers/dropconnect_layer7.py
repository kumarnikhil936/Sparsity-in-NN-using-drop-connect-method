...
# Here applying the dropConnect between hidden layer 7 and hidden layer 8.
...
for keep_percent in np.arange(1, 0.0, -0.05):  # dropping keep_percent in steps of 0.05 in every iteration
    ...
    w8 = tf.Variable(dropConnect(np.genfromtxt('trained_w8.csv', delimiter="\t"), p=keep_percent), dtype=tf.float32, name='w8')
...
# np.savetxt("dl7AccuracyTestNoRetrain.csv", accuracyTest, delimiter="\n", fmt='%.4f')
# np.savetxt("dl7AccuracyTrainNoRetrain.csv", accuracyTrain, delimiter="\n", fmt='%.4f')
# np.savetxt("dl7cvResultsNoRetrain.csv", cvResult, delimiter="\t", fmt='%.4f')

np.savetxt("dl7AccuracyTestWithRetrain.csv", accuracyTest, delimiter="\n", fmt='%.4f')
np.savetxt("dl7AccuracyTrainWithRetrain.csv", accuracyTrain, delimiter="\n", fmt='%.4f')
np.savetxt("dl7cvResultsWithRetrain.csv", cvResult, delimiter="\t", fmt='%.4f')

...
# Here applying the dropConnect between hidden layer 8 and hidden layer 9.
...
for keep_percent in np.arange(1, 0.0, -0.05):  # dropping keep_percent in steps of 0.05 in every iteration
    ...
    w9 = tf.Variable(dropConnect(np.genfromtxt('trained_w9.csv', delimiter="\t"), p=keep_percent), dtype=tf.float32, name='w9')
...
# np.savetxt("dl8AccuracyTestNoRetrain.csv", accuracyTest, delimiter="\n", fmt='%.4f')
# np.savetxt("dl8AccuracyTrainNoRetrain.csv", accuracyTrain, delimiter="\n", fmt='%.4f')
# np.savetxt("dl8cvResultsNoRetrain.csv", cvResult, delimiter="\t", fmt='%.4f')

np.savetxt("dl8AccuracyTestWithRetrain.csv", accuracyTest, delimiter="\n", fmt='%.4f')
np.savetxt("dl8AccuracyTrainWithRetrain.csv", accuracyTrain, delimiter="\n", fmt='%.4f')
np.savetxt("dl8cvResultsWithRetrain.csv", cvResult, delimiter="\t", fmt='%.4f')

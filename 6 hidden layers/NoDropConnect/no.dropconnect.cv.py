...
w2 = tf.Variable(tf.random_normal([250, 200], stddev=0.03), name='w2')
b2 = tf.Variable(tf.random_normal([200]), name='b2')

w3 = tf.Variable(tf.random_normal([200, 150], stddev=0.03), name='w3')
b3 = tf.Variable(tf.random_normal([150]), name='b3')

w4 = tf.Variable(tf.random_normal([150, 140], stddev=0.03), name='w4')
b4 = tf.Variable(tf.random_normal([140]), name='b4')

w5 = tf.Variable(tf.random_normal([140, 140], stddev=0.03), name='w5')
b5 = tf.Variable(tf.random_normal([140]), name='b5')

w6 = tf.Variable(tf.random_normal([140, 120], stddev=0.03), name='w6')
b6 = tf.Variable(tf.random_normal([120]), name='b6')

w7 = tf.Variable(tf.random_normal([120, 10], stddev=0.03), name='w7')
...
y_ = tf.add(tf.matmul(hidden_out_6, w7), b7)

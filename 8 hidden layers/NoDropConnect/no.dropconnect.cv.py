...
w6 = tf.Variable(tf.random_normal([120, 110], stddev=0.03), name='w6')
b6 = tf.Variable(tf.random_normal([110]), name='b6')

w7 = tf.Variable(tf.random_normal([110, 100], stddev=0.03), name='w7')
b7 = tf.Variable(tf.random_normal([100]), name='b7')

w8 = tf.Variable(tf.random_normal([100, 50], stddev=0.03), name='w8')
b8 = tf.Variable(tf.random_normal([50]), name='b8')

w9 = tf.Variable(tf.random_normal([50, 10], stddev=0.03), name='w9')
...
y_ = tf.add(tf.matmul(hidden_out_8, w9), b9)

...
plt.ylabel('Accuracy')
plt.grid(True)
plt.title('\n8 Hidden layers : Accuracy for sparsity applied uniformly over all hidden layers with retraining')
...
plt.ylabel('Accuracy')
plt.grid(True)
plt.title('\n8 Hidden layers : Accuracy for sparsity applied uniformly over all hidden layers without retraining')
...
plt.ylabel('Accuracy')
plt.grid(True)
plt.title('\n8 Hidden layers : Accuracy for sparsity applied between hidden layer 1 and 2 with retraining')
...
plt.ylabel('Accuracy')
plt.grid(True)
plt.title('\n8 Hidden layers : Accuracy for sparsity applied between hidden layer 1 and 2 without retraining')
...
plt.ylabel('Accuracy')
plt.grid(True)
plt.title('\n8 Hidden layers : Accuracy for sparsity applied between hidden layer 2 and 3 with retraining')
...
plt.ylabel('Accuracy')
plt.grid(True)
plt.title('\n8 Hidden layers : Accuracy for sparsity applied between hidden layer 2 and 3 without retraining')
...
plt.ylabel('Accuracy')
plt.grid(True)
plt.title('\n8 Hidden layers : Accuracy for sparsity applied between input layer and hidden layer 1 with retraining')
...
plt.ylabel('Accuracy')
plt.grid(True)
plt.title('\n8 Hidden layers : Accuracy for sparsity applied between input layer and hidden layer 1 without retraining')
...
plt.ylabel('Accuracy')
plt.grid(True)
plt.title('\n8 Hidden layers : Accuracy for sparsity applied between hidden layer 3 and 4 with retraining')
...
plt.ylabel('Accuracy')
plt.grid(True)
plt.title('\n8 Hidden layers : Accuracy for sparsity applied between hidden layer 3 and 4 without retraining')
...
plt.ylabel('Accuracy')
plt.grid(True)
plt.title('\n8 Hidden layers : Accuracy for sparsity applied between hidden layer 4 and 5 with retraining')
...
plt.ylabel('Accuracy')
plt.grid(True)
plt.title('\n8 Hidden layers : Accuracy for sparsity applied between hidden layer 4 and 5 without retraining')
...
plt.ylabel('Accuracy')
plt.grid(True)
plt.title('\n8 Hidden layers : Accuracy for sparsity applied between hidden layer 5 and 6 with retraining')
...
plt.ylabel('Accuracy')
plt.grid(True)
plt.title('\n8 Hidden layers : Accuracy for sparsity applied between hidden layer 5 and 6 without retraining')
...
plt.ylabel('Accuracy')
plt.grid(True)
plt.title('\n8 Hidden layers : Accuracy for sparsity applied between hidden layer 6 and 7 with retraining')
...
plt.ylabel('Accuracy')
plt.grid(True)
plt.title('\n8 Hidden layers : Accuracy for sparsity applied between hidden layer 6 and 7 without retraining')
...
plt.ylabel('Accuracy')
plt.grid(True)
plt.title('\n8 Hidden layers : Accuracy for sparsity applied between hidden layer 7 and 8 with retraining')
...
plt.ylabel('Accuracy')
plt.grid(True)
plt.title('\n8 Hidden layers : Accuracy for sparsity applied between hidden layer 7 and 8 without retraining')
...
plt.ylabel('Accuracy')
plt.grid(True)
plt.title('\n8 Hidden layers : Accuracy for sparsity applied between hidden layer 8 and output layer with retraining')
...
plt.ylabel('Accuracy')
plt.grid(True)
plt.title('\n8 Hidden layers : Accuracy for sparsity applied between hidden layer 8 and output layer without retraining')

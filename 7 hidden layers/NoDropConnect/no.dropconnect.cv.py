...
w2 = tf.Variable(tf.random_normal([200, 180], stddev=0.03), name='w2')
b2 = tf.Variable(tf.random_normal([180]), name='b2')

w3 = tf.Variable(tf.random_normal([180, 160], stddev=0.03), name='w3')
b3 = tf.Variable(tf.random_normal([160]), name='b3')

w4 = tf.Variable(tf.random_normal([160, 140], stddev=0.03), name='w4')
b4 = tf.Variable(tf.random_normal([140]), name='b4')

w5 = tf.Variable(tf.random_normal([140, 120], stddev=0.03), name='w5')
b5 = tf.Variable(tf.random_normal([120]), name='b5')

w6 = tf.Variable(tf.random_normal([120, 100], stddev=0.03), name='w6')
b6 = tf.Variable(tf.random_normal([100]), name='b6')

w7 = tf.Variable(tf.random_normal([100, 100], stddev=0.03), name='w7')
b7 = tf.Variable(tf.random_normal([100]), name='b7')

w8 = tf.Variable(tf.random_normal([100, 10], stddev=0.03), name='w8')
b8 = tf.Variable(tf.random_normal([10]), name='b8')
...
y_ = tf.add(tf.matmul(hidden_out_7, w8), b8)
